<template>
  <div>
    ...
    <b-container fluid class="position-fixed w-100" style="z-index: 10">
      <b-row>
        ...
        <b-col md="6" cols="9" class="text-right pt-4 px-5">
          ...
          <div class="d-inline-block py-2 px-3 bg-white rad-md">
            <b-button @click="showSearch()" class="btn btn-white rad-md px-3 py-2 text-blue">
              <font-awesome-icon icon="search"></font-awesome-icon>
            </b-button>
            <b-button class="btn btn-white rad-md px-3 py-2 mx-2 text-blue" :class="{'btn-white text-blue': showSettings == false, 'btn-blue-white text-white': showSettings == true}" @click="toggleSetting()">
              <font-awesome-icon icon="cog"></font-awesome-icon>
            </b-button>
            <b-button class="btn btn-white rad-md px-3 py-2 text-blue" :class="{'btn-white text-blue': showThumbnails == false, 'btn-blue-white text-white': showThumbnails == true}" @click="toggleThumnails">
    ...
    <!-- Book View -->
    <div v-if="magazineMode == 'book'" class="bg-full-page position-relative" style="overflow: hidden auto">
    ...
    <!-- Slider View -->
    <div v-if="magazineMode == 'slider'" class="bg-full-page position-relative pt-4" style="overflow: hidden auto">
    ...
    <!-- End Slider View -->
        ...
        <!-- Slider View -->
    <b-container v-if="magazineMode == 'scroll'" fluid class="bg-full-page px-0 position-relative py-5" style="overflow-x: hidden !important">
      <b-row class="py-md-5 py-3">
        <b-col md="12" class="py-5">
          <img src="@/assets/img/illust/coming_soon.svg" width="270px" alt="ComingSoon">
          <h1 class="viga text-white">Masih proses pengembangan</h1>
        </b-col>
      </b-row>
    </b-container>
    <!-- End Slider View -->

    <b-container fluid class="navbar-magazine p-3 position-fixed w-100">
      <div class="d-inline-block p-2 toolsMagazine rad-md bg-white shadow" :class="{'tool-hide': navbar == false}">
        <b-button class="btn btn-white p-2 btn-sm" @click="zoomIn()"><font-awesome-icon icon="search-plus"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" @click="firstPage()"><font-awesome-icon icon="backward"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" @click="prevPage()"><font-awesome-icon icon="angle-left"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" :class="{'btn-blue-white text-white': magazineAutoplay == true}" @click="playPage()"><font-awesome-icon :icon="iconAutoplay"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" @click="nextPage()"><font-awesome-icon icon="angle-right"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" @click="endPage()"><font-awesome-icon icon="forward"></font-awesome-icon></b-button>
        <b-button class="btn btn-white p-2 btn-sm" @click="zoomOut()"><font-awesome-icon icon="search-minus"></font-awesome-icon></b-button>
      </div>
    </b-container>
    <b-container fluid class="px-2 settings-magazine overflow-hidden">
      <div class="settings-content text-left p-md-5 p-5"  :class="{'settings-hide': showSettings == false, 'settings-show': showSettings == true}">
          ...
          <div class="w-100">
            <b-row>
              ...
              <b-col md="8" class="text-center">
                ...
                <b-form-checkbox v-model="themeStyle" class="d-inline-block mx-3" :options='optionTheme' name="check-button" switch></b-form-checkbox>
                <span class="d-inline-block" style="font-size: .9rem"><font-awesome-icon :icon="['far', 'moon']"></font-awesome-icon> Dark</span>
              </b-col>
            </b-row>
          </div>s
        </div>
        <h2 class="viga mt-3">Advance</h2>
        <div class="border-bottom pb-3 mt-3">
          <h5 class="viga">Profile</h5>
          <div class="w-100">
            <b-row>
              <b-col md="6" class="mt-2">
                <p class="mb-0" style="font-size: .9rem">Photo profile</p>
              </b-col>
              <b-col md="6" class="text-center">
                <b-form-file v-model="avatarFile" id="avatar-file" @change="changeAvatar" class="d-none"></b-form-file>
                <div class="avatar-profile" @click="callFile">
                  <img v-if="srcPreview == ''" :src="`${web}images/user/avatar/avatar.svg`" alt="Avatar">
                  <img v-if="srcPreview != ''" :src="`${srcPreview}`" alt="Avatar">
                </div>
              </b-col>
            </b-row>
            <b-row>
              <b-col md="6" class="mt-2">
                <p class="mb-0" style="font-size: .9rem">Username</p>
              </b-col>
              <b-col md="6" class="text-center">
                <b-form-input v-model="usernameProfile" placeholder="Username"></b-form-input>
              </b-col>
            </b-row>
          </div>
        </div>
        <button class="btn btn-blue-white w-100 py-3 rad-md text-white viga">Masuk</button>
      </div>
    </b-container>
